...
$(function(){
    ...
    */
    ...
    $(".btn-danger").on("click", ()=>{
        //animateP(); - nefunkční
        $("h1").css("background-color", "black").html("We are <em>ANONYMOUS</em>");
        $("#collapsibleNavId").parents("nav").remove();
        $("#zakladni-udaje").children().not("h2, div:first").remove();
        $("figcaption").remove();
        $("img:last").attr("src", "img/anon.jpg");
        $("h2").css("background-color", "grey").html("YOU ARE BEING WATCHED");
        $("body").css("background-color", "#292e33");
        $("p").not(".poznamka").css("color", "white");
        $("footer").children().not(".text-center").remove();
        $("main").children("h3").css("color", "grey"); // .css({"color": "grey"}); - nefunguje ani jedním způsobem
        $("title").html("WE ARE ANONYMOUS");
    });
});
...
function animateP(){
    ...
    $("main").children("p").animate({ top: newPos[0], left: newPos[1] }, function(){
      animateP();        
    }); 
}; */